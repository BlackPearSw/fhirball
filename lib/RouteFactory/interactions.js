...
function getLocation(req, doc){
    return req.protocol + '://' + req.headers.host + req.originalUrl + '/' + doc._id + '/_history/' + doc.version;
}
...
exports.update = function (model) {
    return function (req, res) {
        ...
        req.on('end', function () {
            ...
            fhirgoose.fhir[obj.resourceType].findOneAndUpdateWithOptimisticConcurrencyCheck(obj, function (err, doc) {
...
exports.delete = function (model) {
    return function (req, res) {
        ...
        var conditions = {'_id' : fhirgoose.util.createObjectId(req.params.id)};
