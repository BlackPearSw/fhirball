    ...
    function makeModelFromSchema(schema, callback){
        try {
            ...
            model.findOneAndUpdateWithOptimisticConcurrencyCheck = function (obj, callback) {
                model.findOneAndUpdate({_id: obj.id, _version: obj._version}, {$inc: {_version: 1}, $set: {resource: obj.resource, meta: obj.meta}, $addToSet: {tags: { $each: obj.tags}}}, function (err, doc) {
